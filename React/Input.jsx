...
//app ke andar input component aayega na to app.jsx mai use karna hai
...
//and jab ek baar submit button pai click ho to again task empty kardo
// export default Input;

//ye export and import links cdn mai nhi chlega
//to Input ko index mai upar rakho app ke to uska use kar paoge variable, class or function ka input ke app ke andar
